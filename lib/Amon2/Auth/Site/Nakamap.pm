...
package Amon2::Auth::Site::Nakamap;
use Mouse;
...
sub callback {
    ...
    if ($self->user_info) {
        my $res = $self->ua->get("https://thanks.nakamap.com/1/me?token=${access_token}");
...
Amon2::Auth::Site::Nakamap - Nakamap integration for Amon2
...
This is a nakamap authentication module for Amon2. You can call a nakamap APIs with this module.
...
C<< $user >> contains user information.
